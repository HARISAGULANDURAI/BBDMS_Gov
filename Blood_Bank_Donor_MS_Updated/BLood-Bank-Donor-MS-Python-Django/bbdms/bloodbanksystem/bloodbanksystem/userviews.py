...
# def CONTACTUS(request):
#     if request.method == 'POST':
#         full_name = request.POST.get('full_name')  # Match the model field name
#         mobile_number = request.POST.get('mobile_number')  # Match the model field name
#         email = request.POST.get('email')
#         message = request.POST.get('message')
#
#         # Create a Contact instance using the correct field names
#         contactuser = Contact(
#             full_name=full_name,
